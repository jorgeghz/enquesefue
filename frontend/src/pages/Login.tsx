...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (err === 'google_cancelled') setError('Inicio de sesión con Google cancelado.')
    if (err === 'google_failed') setError('Error al conectar con Google. Intenta de nuevo.')
  }, [searchParams])
  ...
  const handleGoogle = async () => {
    try {
      ...
      setError('No se pudo iniciar el flujo de Google. ¿Está configurado?')
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">💸 enquesefue</h1>
